...
k_fit <- readRDS("k-means-clustering/throughput/k6-best-model.rds")
...
write_csv(cluster_centers_df, "k-means-clustering/output/tables/tab01-k6-cluster-zscores.csv")

# Export means
write_csv(cluster_means, "k-means-clustering/output/tables/tab02-k6-cluster-means.csv")
...
write_csv(cluster_intervals_formatted, "k-means-clustering/output/tables/tab03-k6-cluster-90pct-intervals.csv")
