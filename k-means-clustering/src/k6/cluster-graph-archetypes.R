...
k_data <- readRDS("k-means-clustering/throughput/k6-best-model-cluster-labels.rds")
...
ggsave("k-means-clustering/output/figures/fig07-k6-household-counts-time-line.jpg",
       plot_counts, 
       width = 6, height = 6, 
       dpi = 300,
       scale = 1.25)

ggsave("k-means-clustering/output/figures/fig08-k6-household-percents-time-line.jpg",
       plot_percents, 
       width = 6, height = 6, 
       dpi = 300,
       scale = 1.25)

ggsave("k-means-clustering/output/figures/fig09-k6-household-relative-1900-line.jpg",
       plot_relative1900, 
       width = 6, height = 6, 
       dpi = 300,
       scale = 1.25)

ggsave("k-means-clustering/output/figures/fig10-k6-household-relative-2023-line.jpg",
       plot_relative2023, 
       width = 6, height = 6, 
       dpi = 300,
       scale = 1.25)
...
write_csv(cluster_counts_year,
          "k-means-clustering/output/figure-data/fig07-k6-household-counts-time-line.csv")

write_csv(cluster_percents_year,
          "k-means-clustering/output/figure-data/fig08-k6-household-percents-time-line.csv")

write_csv(cluster_percents_rel_1900,
          "k-means-clustering/output/figure-data/fig09-k6-household-relative-1900-line.csv")

write_csv(cluster_percents_rel_2023,
          "k-means-clustering/output/figure-data/fig10-k6-household-relative-2023-line.csv")
