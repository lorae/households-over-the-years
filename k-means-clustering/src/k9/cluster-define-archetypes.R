...
k_fit <- readRDS("k-means-clustering/throughput/k9-best-model.rds")
k_data <- readRDS("k-means-clustering/throughput/k9-best-model-cluster-labels.rds")

# Initialize output paths
cluster_centers_path <- "k-means-clustering/output/tables/tab04-k9-cluster-zscores.csv"
cluster_means_path <- "k-means-clustering/output/tables/tab05-k9-cluster-means.csv"
cluster_90pct_intervals_path <- "k-means-clustering/output/tables/tab06-k9-cluster-90pct-intervals.csv"
...
write_csv(cluster_centers_df, cluster_centers_path)

# Export means
write_csv(cluster_means, cluster_means_path)
...
write_csv(cluster_intervals_formatted, cluster_90pct_intervals_path)
