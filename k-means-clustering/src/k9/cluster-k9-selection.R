...
out_dir <- "k-means-clustering/output"
...
lowest_ss_data_path <- glue("k-means-clustering/output/figure-data/fig{fignum}-k{k}-model-ss-{timestamp}.csv")
lowest_ss_fig_path <- glue("k-means-clustering/output/figures/fig{fignum}-k{k}-model-ss-{timestamp}.png")
best_model_path <- glue("k-means-clustering/throughput/k{k}-best-model.rds")
labelled_cluster_path <- glue("k-means-clustering/throughput/k{k}-best-model-cluster-labels.rds")
all_models_path <- glue("k-means-clustering/throughput/k{k}-all-models-{timestamp}.rds")
