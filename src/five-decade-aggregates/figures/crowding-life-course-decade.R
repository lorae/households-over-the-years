...
dir.create("output/five-decade-tables/figures", recursive = TRUE, showWarnings = FALSE)

# Save plot
ggsave(
  filename = "output/five-decade-tables/figures/crowded_by_age_and_decade.png",
  plot = p,
  width = 8,
  height = 5,
  dpi = 300
