...
crowding_overall <- read_csv("five-decade-aggregates/output/raw/crowded_overall.csv")

crowding_race <- read_csv("five-decade-aggregates/output/raw/crowded_race.csv")

crowding_income <- read_csv("five-decade-aggregates/output/raw/crowded_income_everyone.csv")

crowding_tenure <- read_csv("five-decade-aggregates/output/raw/crowded_tenure.csv")

crowding_birthplace <- read_csv("five-decade-aggregates/output/raw/crowded_birthplace.csv")
# ----------------------------
...
# Export
# ----------------------------
write_xlsx(export_tbl, "five-decade-aggregates/output/crowding_percent_by_group.xlsx")